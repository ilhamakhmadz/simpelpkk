									...
									<form class="form d-flex flex-center" id="form_edit" name="form_edit" method="post">
										<div class="card-body mw-800px py-20">
											<div class="fv-row row ">
												<div class="col-lg-6 col-md-6">
													...
													<div class="">
														...
														<input type="hidden" name="id" id="id" value="<?=$bumdes->id?>">
														<select class="form-select form-select-lg form-select-solid" data-control="select2" data-control="select2" data-placeholder="Pilih Kecamatan" name="kd_kec" id="kd_kec" disabled>
															<option value='<?= $bumdes->Kd_Kec ?>'><?= $bumdes->Nama_Kecamatan ?></option>
															<?php
												...
												<div class="col-lg-6 col-md-6">
													...
													<div class="">
														...
														<select class="form-select form-select-lg form-select-solid" data-control="select2" data-control="select2" data-placeholder="Pilih Desa" name="kd_desa" id="kd_desa" disabled>
															<option value='<?= $bumdes->Kd_Desa ?>'><?= $bumdes->Nama_Desa ?></option>
														</select>
													</div>
													<!--end::Form Group-->
												</div>
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<input class="form-control form-control-lg form-control-solid required" type="text" value='<?= $bumdes->nama ?>' id="nama" name="nama"  required>
													</div>
												</div>
											</div>
											<!--end::Form row-->
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<select class="form-select form-select-lg form-select-solid" data-control="select2" data-control="select2" data-placeholder="Pilih Status" name="status" id="status" required>
															<option value='<?= $bumdes->status ?>'><?= $bumdes->status ?></option>
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<input class="form-control form-control-lg form-control-solid required" type="text" value='<?= $bumdes->alamat ?>' id="alamat" name="alamat"  required>
													</div>
												</div>
											</div>
											<!--end::Form row-->
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<select class="form-select form-select-lg form-select-solid" data-control="select2" data-control="select2" data-placeholder="Pilih Jenis Usaha" name="jenis_usaha" id="jenis_usaha" required>
															<option value='<?= $bumdes->jenis_usaha ?>'><?= $bumdes->jenis_usaha ?></option>
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<div class="input-group input-group-lg input-group-solid">
															...
															<input class="form-control form-control-lg form-control-solid required" type="text" value='<?= $bumdes->omset ?>' id="omset" name="omset"  required>
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<div class="input-group input-group-lg input-group-solid">
															<span class="input-group-text pe-5">Rp.</span>
															<input class="form-control form-control-lg form-control-solid required" type="text" value='<?= $bumdes->profit ?>' id="profit" name="profit"  required>
															<span class="input-group-text pe-5">/Tahun</span>
														</div>
													</div>
												</div>
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<div class="input-group input-group-lg input-group-solid">
															<span class="input-group-text pe-5">Rp.</span>
															<input class="form-control form-control-lg form-control-solid required" type="text" value='<?= $bumdes->kontribusi_pad ?>' id="kontribusi_pad" name="kontribusi_pad"  required>
															<span class="input-group-text pe-5">/Tahun</span>
														</div>
													</div>
												</div>
