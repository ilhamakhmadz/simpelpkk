<div class="card">
    <div class="card-body p-12">
        <div class="row mb-12">
            <table id="dataTable_unggulan_desa" class="table table-striped table-row-bordered gy-5 gs-7">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="symbol symbol-60px symbol-2by3 me-4">
								<img src="<?=(empty($data->gambar_produk)) ? base_url('/assets/admin_assets/assets/media/avatars/blank.png') : base_url(base64_decode($data->gambar_produk));?>" alt="" class="mw-100">
							</div>
                        </td>
                        <td>
                        <a href="<?=base_url()?>produk_desa/unggulan/edit/<?=$data->id?>" class="btn btn-icon btn-light-facebook me-5 " >
                        ...
                        <a href="#" onclick="deleteItem(<?=$data->id.','.$data->kode_desa?>)" class="btn btn-icon btn-light-google me-5 ">
