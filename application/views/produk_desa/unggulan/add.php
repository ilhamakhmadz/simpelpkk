	...
	<form class="form d-flex flex-center" id="form_add" name="form_add" method="post">
		<div class="card-body mw-1000px py-20">
			...
			<div class="row mb-8">
				...
				<div class="col-lg-9">
					<div class="spinner spinner-sm spinner-primary spinner-right">
						<input class="form-control form-control-lg form-control-solid" type="text" id="nama_produk" name="nama_produk">
					</div>
				</div>
			</div>
			<!--end::Form row-->
			...
			<div class="row mb-8">
				...
				<div class="col-lg-9">
					<div class="spinner spinner-sm spinner-primary spinner-right">
						<input class="form-control form-control-lg form-control-solid" type="number" id="harga_produk" name="harga_produk">
					</div>
				</div>
			</div>
			<!--end::Form row-->
					...
					<div class="spinner spinner-sm spinner-primary spinner-right">
						<div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url(<?= base_url('/assets/admin_assets/assets/media/avatars/blank.png') ?>)">
							...
							<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Change avatar">
								...
								<!--begin::Inputs-->
								<input type="file" name="avatar" id="gambar_produk" accept=".png, .jpg, .jpeg" />
			...
			<div class="fv-row mb-10">
				<a onclick="tambahProduk()" class="btn btn-icon btn-twitter btn-sm me-3">
					<i class="fas fa-plus"></i>
				</a>
			</div>
			<div class="border-top mt-5"></div><br>
			<!-- <div class="fv-row mb-12"> -->
			<table class="table gs-7 gy-7 gx-7" id="table-produk">
				<thead>
