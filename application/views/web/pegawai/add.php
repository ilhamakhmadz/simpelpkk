...
<div class="card">
									...
									<form class="form d-flex flex-center" id="form_add" name="form_add" method="post">
										<div class="card-body mw-800px py-20">
											...
											<div class="fv-row row ">
												<div class="col-lg-12 col-md-12">
													<label class="fs-6 mt-5 form-label fw-bolder required">Nama Pegawai</label>
											...
											<div class="fv-row row ">
												<div class="col-lg-12 col-md-12">
													...
													<input class="form-control form-control-lg form-control-solid" type="number" id="nip" name="nip" required>
												</div>
