										...
										<div class="card-body mw-800px py-20">
											<div class="fv-row row ">
												<div class="col-lg-12 col-md-12">
													...
													<input class="form-control form-control-lg form-control-solid" type="text" id="judul" name="judul" value="<?=$profil->judul;?>" required>
											...
											<div class="fv-row row ">
												<div class="col-lg-12 col-md-12">
													...
													<textarea name="isi_berita" id="isi_berita" required><?=$profil->isi;?></textarea>
												</div>
												...
												<div class="col-lg-12 col-md-12">
													<label class="fs-6 mt-5 form-label fw-bolder required">Upload Gambar</label>
														<div class="spinner spinner-sm spinner-primary spinner-right">
															...
															<div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url(<?= (empty($profil->gambar)) ? base_url('/assets/admin_assets/assets/media/avatars/blank.png') : base_url(base64_decode($profil->gambar)); ?>)">
																	...
																	<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Ubah Logo">
																		...
																		<input type="hidden" name="gambar_remove" id="gambar_remove" value="<?=$profil->gambar;?>"/>
																		<!--end::Inputs-->
																	</label>
																	<!--end::Edit button-->
