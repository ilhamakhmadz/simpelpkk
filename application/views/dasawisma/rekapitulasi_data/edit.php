                        ...
                        <div class="fv-row row ">
                                <div class="col-lg-12 col-md-12 mb-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Pilih Level" name="level"
                                            id="level" disabled>
                                            <option value="<?=$rekapitulasi_data->level?>"><?=$rekapitulasi_data->level?></option>
                                            <?php
                                ...
                                <div class="fv-row row mb-5">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" disabled value="<?= $rekapitulasi_data->nama_kepala_keluarga ?>" name="nama_kepala_keluarga" id="nama_kepala_keluarga">
                                            <input type="hidden" class="form-control form-control-lg form-control-solid" value="<?= $rekapitulasi_data->id_data_keluarga ?>" name="id_data_keluarga" id="id_data_keluarga">
                                            <input type="hidden" class="form-control form-control-lg form-control-solid" value="<?= $rekapitulasi_data->id_data_rekapitulasi ?>" name="id_data_rekapitulasi" id="id_data_rekapitulasi">
                                        </select>
                                        </div>
                                        <!--begin::Form Group-->
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div id="div-kec">
                                        ...
                                        <select class="form-select form-select-lg form-select-solid" data-placeholder="Pilih Kecamatan" name="kd_kec" id="kd_kec" disabled required>
                                                            <option value="<?=$rekapitulasi_data->kecamatan?>"><?=$rekapitulasi_data->Nama_Kecamatan?></option>
															 <?php
                                ...
                                <div class="col-lg-4 col-md-4 ">
                                    ...
                                    <div id="div-desa">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid" data-placeholder="Pilih Desa" disabled value="<?=$rekapitulasi_data->Nama_Desa?>" name="nama_desa" id="nama_desa">
                                        <input type="hidden" class="form-control form-control-lg form-control-solid" data-placeholder="Pilih Desa" value="<?=$rekapitulasi_data->desa?>" name="kd_desa" id="kd_desa">
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-4 col-md-4 ">
									...
									<div id="div-dusun">
										...
										<input value="<?=$rekapitulasi_data->Nama_Desa?>" disabled class="form-control form-control-lg form-control-solid" type="text" 
                                ...
                                <div class="col-lg-6 col-md-6 mt-6">
									...
									<div id="div-rt">
										...
										<input value="<?=$rekapitulasi_data->rt?>" disabled class="form-control form-control-lg form-control-solid" type="number" 
                                ...
                                <div class="col-lg-6 col-md-6 mt-6">
									...
									<div id="div-rw">
										...
										<input value="<?=$rekapitulasi_data->rw?>" disabled class="form-control form-control-lg form-control-solid" type="number"
                            ...
                            <div class="fv-row row ">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="">
                                            ...
                                            <input value="<?=$rekapitulasi_data->dasawisma?>" type="text" placeholder="-" class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input required type="text" placeholder="-" class="form-control form-control-lg form-control-solid"
                                            name="nama_ibu" id="nama_ibu" value="<?=$rekapitulasi_data->nama_ibu?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input required type="text" placeholder="-" class="form-control form-control-lg form-control-solid"
                                            name="nama_suami" id="nama_suami" value="<?=$rekapitulasi_data->nama_suami?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <select required name="status" id="status" class="form-select form-select-lg form-select-solid" data-placeholder="Pilih">
                                            <option value="<?=$rekapitulasi_data->status?>"><?=$rekapitulasi_data->status?></option>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" placeholder="-" class="form-control form-control-lg form-control-solid"
                                            name="nama_bayi" id="nama_bayi" value="<?=$rekapitulasi_data->nama_bayi?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-select form-select-lg form-select-solid" data-placeholder="Pilih">
                                            <?php
                                                if($rekapitulasi_data->laki_laki == 1){
                                                    echo '<option value="1">Laki-Laki</option>
                                                    <option value="2">Perempuan</option>';
                                                }else if($rekapitulasi_data->perempuan == 1){
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="date" placeholder="0" class="form-control form-control-lg form-control-solid"
                                            name="tanggal_lahir" id="tanggal_lahir" value="<?=$rekapitulasi_data->tanggal_lahir?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select name="akte_kelahiran" id="akte_kelahiran" class="form-select form-select-lg form-select-solid" data-placeholder="Pilih">
                                            <?php
                                                if($rekapitulasi_data->ada_akte_kelahiran == 1){
                                                    echo '<option value="1">Ada</option>
                                                    <option value="2">Tidak Ada</option>';
                                                }else if($rekapitulasi_data->tidak_ada_akte_kelahiran == 1){
                                                    echo '<option value="2">Tidak Ada</option>
                            ...
                            <div class="fv-row row ">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" placeholder="-" class="form-control form-control-lg form-control-solid"
                                            name="nama_meninggal" id="nama_meninggal" value="<?=$rekapitulasi_data->nama_meninggal?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <select name="jenis_kelamin_meninggal" id="jenis_kelamin_meninggal" class="form-select form-select-lg form-select-solid" data-placeholder="Pilih">
                                            <?php
                                                if($rekapitulasi_data->laki_laki_meninggal == 1){
                                                    echo '<option value="1">Laki-Laki</option>
                                                    <option value="2">Perempuan</option>';
                                                }else if($rekapitulasi_data->perempuan_meninggal == 1){
                                                    echo '<option value="2">Perempuan</option>
                                                    <option value="1">Laki-Laki</option>';
                                                }else{
                                                    echo '<option value="">Pilih</option>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="date" placeholder="-" class="form-control form-control-lg form-control-solid"
                                            name="tanggal_meninggal" id="tanggal_meninggal" value="<?=$rekapitulasi_data->tanggal_meninggal?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            </div>  
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea class="form-control form-control-lg form-control-solid" name="sebab"
                                            id="sebab"><?=$rekapitulasi_data->sebab_meninggal?></textarea>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea class="form-control form-control-lg form-control-solid" name="ket"
                                            id="ket"><?=$rekapitulasi_data->ket?></textarea>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            </div>
