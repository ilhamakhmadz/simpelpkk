                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="pekerjaan" class="table vm trans table-small-font no-mb table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th rowspan="2">No</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data_pekerjaan->jumlah ?></td>
                                                    <td><?= $data_pekerjaan->persen ?></td>
                                                    <td><?= $data_pekerjaan->laki ?></td>
                                                    <td><?= $data_pekerjaan->persen1 ?></td>
                                                    <td><?= $data_pekerjaan->laki ?></td>
                                                    <td><?= $data_pekerjaan->persen2 ?></td>
                                                </tr>
                                        <?php
                                            }
                                        }
