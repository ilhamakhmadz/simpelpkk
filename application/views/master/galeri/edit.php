        ...
        <div class="content fs-6 d-flex flex-column-fluid" id="kt_content" data-select2-id="select2-data-kt_content">
            ...
            <div class="container" data-select2-id="select2-data-13-guag">
                ...
                <div class="card" data-select2-id="select2-data-12-xgkw">
                    <!--begin::Form-->
                    <form class="form d-flex flex-center" data-select2-id="select2-data-11-fnw9" id="form_edit"
                        name="form_edit" method="post" action="">
                        <div class="card-body mw-800px py-20" data-select2-id="select2-data-10-xs94">


                            <!--begin::Form row-->
                            <div class="row mb-8">
                                <label class="col-lg-3 col-form-label">Nama Galeri</label>
                                <div class="col-lg-9">
                                    <div class="input-group input-group-lg input-group-solid">
                                        <input type="hidden" class="form-control" id="id" name="id"
                                            value="<?=$galeri->id?>" required disabled>
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            id="nama_galeri" name="nama_galeri" value="<?=$galeri->nama_galeri?>"
                                            required>
                                    </div>
                                </div>
                            </div>
