					...
					<form class="form d-flex flex-center" data-select2-id="select2-data-11-fnw9" id="form_add" name="form_add" method="post">
						<div class="card-body mw-800px py-20" data-select2-id="select2-data-10-xs94">
							...
							<div class="row mb-8">
								...
								<div class="col-lg-9">
									<div class="spinner spinner-sm spinner-primary spinner-right">
										<select class="form-select" data-control="select2" data-placeholder="Pilih Kecamatan" name="kec_id" id="kec_id">
											<option></option>
											<?php
							...
							<div class="row mb-8">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control form-control-lg form-control-solid" id="kd_kecamatan" name="kd_kecamatan" required disabled>
								</div>
								<div class="col-lg-6">
									<input type="text" class="form-control form-control-lg form-control-solid" id="kd_desa" name="kd_desa" required>
								</div>
							</div>
							<!--end::Form row-->
							<!--begin::Form row-->
							...
							<div class="row mb-8">
								...
								<div class="col-lg-9">
									<div class="input-group input-group-lg input-group-solid">
										<input type="text" class="form-control form-control-lg form-control-solid" id="nama_desa" name="nama_desa" required>
									</div>
								</div>
							</div>
							<!--end::Form row-->
