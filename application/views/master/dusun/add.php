				...
				<div class="card" data-select2-id="select2-data-12-xgkw">
					...
					<form class="form d-flex flex-center" data-select2-id="select2-data-11-fnw9" id="form_add" name="form_add" method="post">
						<div class="card-body mw-800px py-20" data-select2-id="select2-data-10-xs94">
							<!--begin::Form row-->
							<div class="row mb-8">
								<label class="col-lg-3 form-label  fw-bolder">Pilih Desa</label>
								<div class="col-lg-9">
									<div class="spinner spinner-sm spinner-primary spinner-right">
										<select class="form-select" data-control="select2" required data-placeholder="Pilih Desa" name="kd_desa" id="kd_desa">
											<option></option>
											<?php
                                            foreach ($desa_value as $nama) {
                                                echo "<option value='" . $nama->Kd_Desa . "'>" . $nama->Nama_Desa . "</option>";
                                            }
                                            ?>
										</select>
							...
							<div class="row mb-8">
								<label class="col-lg-3 col-form-label required">Nama Dusun</label>
								<div class="col-lg-9">
									<div class="input-group input-group-lg input-group-solid">
										<input type="text" style="text-transform:uppercase" class="form-control form-control-lg form-control-solid" id="nama_dusun" name="nama_dusun" required>
										<input type="hidden" class="form-control form-control-lg form-control-solid" id="kd_kecamatan" name="kd_kecamatan" value="<?= $desa->Kd_Kec ?>" required>
									</div>
								</div>
							</div>
							<!--end::Form row-->
