								...
								<div class="card" data-select2-id="select2-data-12-xgkw">
									...
									<form class="form d-flex flex-center" data-select2-id="select2-data-11-fnw9" id="form_add" name="form_add" method="post">
										<div class="card-body mw-800px py-20" data-select2-id="select2-data-10-xs94">
											<!--begin::Form row-->
											<div class="row mb-8">
												<label class="col-lg-3 col-form-label required">Nama Pelatihan</label>
												<div class="col-lg-9">
													<div class="input-group input-group-lg input-group-solid">
														<input type="text" class="form-control form-control-lg form-control-solid" id="nama_pelatihan" name="nama_pelatihan" required>
													</div>
												</div>
											</div>
											<!--end::Form row-->
