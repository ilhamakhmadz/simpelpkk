											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="input-group input-group-lg input-group-solid">
														<input type="hidden" class="form-control" id="id" name="id" value="<?=$pelatihan->id?>" required disabled>
														<input type="text" class="form-control form-control-lg form-control-solid" id="nama_pelatihan" name="nama_pelatihan" value="<?=$pelatihan->nama_pelatihan?>" required>
													</div>
												</div>
											</div>
											<!--end::Form row-->
