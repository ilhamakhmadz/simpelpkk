<div class="card">
    <div class="card-body p-12">
        <div class="row mb-12">
            <table id="dataTable_dasawisma" class="table table-striped table-row-bordered gy-5 gs-7">
                <thead>
                ...
                <tbody class="text-gray-600 fw-bold">
                    <?php $i=1; foreach($dasawisma as $value):?>
                        <tr>
                            <td><?= $i; ?></td>
                            ...
                            <td><?= $value->rw; ?></td>
                            <td><?= $value->rt; ?></td>
                            <td><?= $value->dasawisma; ?></td>
                            <td>
                                <a href="<?=site_url().'/master/kecamatan/edit_dasawisma/'.$value->id?>" class="btn btn-icon btn-light-facebook me-5 ">
                                ...
                                <a onclick="deleteItem('<?= $value->id ?>', '<?= $value->Kd_Desa ?>', '<?= $value->Kd_Dusun ?>', '<?= $value->rw ?>', '<?= $value->rt ?>')"                                
