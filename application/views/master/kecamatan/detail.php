        ...
        <div class="row mb-12">
            <table id="dataTable_desa" class="table table-striped table-row-bordered gy-5 gs-7">
                ...
                <tbody class="text-gray-600 fw-bold">
                    <?php $i=1; foreach($desa as $value):?>
                        <tr>
                            <td><?= $i; ?></td>
                            <td><?= $value->Kd_Desa; ?></td>
                            <td><?= $value->Nama_Desa; ?></td>
                            <td>
                                <a href="<?=site_url().'/master/kecamatan/detail_dusun/'.$value->Kd_Desa?>" class="btn btn-icon btn-light-facebook me-5 ">
                                ...
                                <a href="<?=site_url().'/master/kecamatan/edit_desa/'.$value->id?>" class="btn btn-icon btn-light-facebook me-5 ">
                                ...
                                <a href="<?=site_url(). 'master/kecamatan/generate_user_desa/'. $value->id ?>" class="btn btn-icon btn-light-instagram me-5 ">
                                ...
                                <a onclick="deleteItem(<?=$value->id?>)" class="btn btn-icon btn-light-google me-5 ">
