<section class="page-banner">
    <div class="container">
        <div class="page-title-wrapper">
            <h1 class="page-title">Lembaga Kemasyarakatan Desa</h1>
            <ul class="bradcurmed">
                <li><a href="<?=base_url('welcome')?>" rel="noopener noreferrer">Home</a></li>
                <li>Lembaga Kemasyarakatan Desa</li>
            </ul>
        </div>
        <!-- /.page-title-wrapper -->
    </div>
                ...
                <tbody class="text-gray-600 fw-bold">
                    <?php $no="1"; foreach ($lkd as $data):?>
                        <tr>
                            ...
                            <td>
                                <?=$data->rt?><br>
                                <b>Status : <?=$data->rt_aktif?></b> 
                            </td>
                            <td>
                                <?=$data->rw?><br>
                                <b>Status : <?=$data->rw_aktif?></b> 
                            </td>
                            <td>
                                <?=$data->pkk?><br>
                                <b>Status : <?=$data->pkk_aktif?></b> 
                            </td>
                            <td>
                                <?=$data->posyandu?><br>
                                <b>Status : <?=$data->posyandu_aktif?></b> 
                            </td>
                        </tr>
                    <?php $no++; endforeach;?>
