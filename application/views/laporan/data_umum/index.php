...
<div class="card card-stretch mb-5 mb-xxl-8">
    ...
    <div class="card-body pt-2 pb-0 mt-n3">
        <div class="tab-content mt-5" id="myTabTables1">
                    ...
                    ?>
                            ...
                            <div class="tab-pane fade active show" id="kt_tab_pane_1_1" role="tabpanel" aria-labelledby="kt_tab_pane_1_1">
                                ...
                                <div class=" row col-md-6">
                                    <?php if($this->acl->is_allowed('laporan/data_umum/pdf')): ?>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <a class="btn btn-sm btn-danger float-right m-t-n-xs" href="#" onclick="cetakPdf(1)" class="form-control"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <strong>Cetak PDF</strong></a>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($this->acl->is_allowed('laporan/data_umum/excel')): ?>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable_profil_kecamatan" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_1_2" role="tabpanel" aria-labelledby="kt_tab_pane_1_2">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_desa" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th>No</th>
                                                <th>Tahun Pendataan</th>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_1_3" role="tabpanel" aria-labelledby="kt_tab_pane_1_3">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_dusun" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th>No</th>
                                                <th>Tahun Pendataan</th>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_rw" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th>No</th>
                                                <th>Tahun Pendataan</th>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_1_5" role="tabpanel" aria-labelledby="kt_tab_pane_1_5">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_rt" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th>No</th>
                                                <th>Tahun Pendataan</th>
                    ...
                    ?>
                            <!--begin::Tap pane-->
                            <div class="tab-pane fade active show" id="kt_tab_pane_1_2" role="tabpanel" aria-labelledby="kt_tab_pane_1_2">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_desa" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
                    ...
                    ?>
                             <!--begin::Tap pane-->
                            <div class="tab-pane fade active show" id="kt_tab_pane_1_5" role="tabpanel" aria-labelledby="kt_tab_pane_1_5">
                                <!--begin::Table-->
                                <div class="table-responsive">
                                    <table id="dataTable_profil_rt" class="table table-striped table-row-bordered gy-5 gs-7">
                                        <thead>
