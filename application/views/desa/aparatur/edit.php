        ...
        <div class="card-body mw-800px py-20">
                ...
                <div class="col-lg-9">
                    <div class="spinner spinner-sm spinner-primary spinner-right">
                        ...
                        <input class="form-control form-control-lg form-control-solid required" type="text"
                            id="kepala_desa" name="kepala_desa" value="<?=$aparatur->kepala_desa?>" required>
                    </div>
                </div>
            </div>
            <!--end::Form row-->
                ...
                <div class="col-lg-9">
                    <div class="spinner spinner-sm spinner-primary spinner-right">
                        <input class="form-control form-control-lg form-control-solid required" type="text" id="kaur_tu"
                            name="kaur_tu" value="<?=$aparatur->kaur_tu?>" required>
                    </div>
                </div>
            </div>
            <!--end::Form row-->
            ...
            <div class="row mb-8">
                ...
                <div class="col-lg-9">
                    <div class="spinner spinner-sm spinner-primary spinner-right">
                        <input class="form-control form-control-lg form-control-solid required" type="text"
                            id="kaur_keuangan" name="kaur_keuangan" value="<?=$aparatur->kaur_keuangan?>" required>
                    </div>
                </div>
            </div>
            <!--end::Form row-->
                ...
                <div class="col-lg-9">
                    <div class="spinner spinner-sm spinner-primary spinner-right">
                        <input class="form-control form-control-lg form-control-solid " type="text"
                            value="<?=$aparatur->staf_1?>" id="staf_1" name="staf_1">
                    </div>
                </div>
            </div>
            <!--end::Form row-->
            ...
            <div class="row mb-8">
                ...
                <div class="col-lg-9">
                    <div class="spinner spinner-sm spinner-primary spinner-right">
                        <input class="form-control form-control-lg form-control-solid " type="text"
                            value="<?=$aparatur->staf_2?>" id="staf_2" name="staf_2">
                    </div>
                </div>
            </div>
            <!--end::Form row-->
