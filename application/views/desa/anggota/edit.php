													...
													<div class="col-lg-6 col-md-6">
														...
														<div class="">
															...
															<input type="number" class="form-control form-control-lg form-control-solid"
																name="nik" id="nik" value="<?=$anggota->nik?>"/>
														</div>
														<!--end::Form Group-->
													</div>
													<div class="col-lg-6 col-md-6">
														...
														<div class="">
															...
															<input type="number" class="form-control form-control-lg form-control-solid"
																name="kk" id="kk" value="<?=$anggota->kk?>"/>
														</div>
														<!--end::Form Group-->
													</div>
												</div>
                            ...
                            <div class="fv-row row ">
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="hidden" name="aparatur_id" id="aparatur_id" value="<?=$aparatur?>">
                                        <input type="hidden" name="kode_kecamatan" id="kode_kecamatan" value="<?=$anggota->kode_kecamatan?>">
                                        <input type="hidden" name="kode_desa" id="kode_desa" value="<?=$anggota->kode_desa?>">
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="no_reg_tp_pkk" id="no_reg_tp_pkk" value="<?=$anggota->no_reg_tp_pkk?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-5 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="nama" id="nama" value="<?=$anggota->nama?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            ...
                            <div class="fv-row row ">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="tempat_lahir" id="tempat_lahir" value="<?=$anggota->tempat_lahir?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="date" class="form-control form-control-lg form-control-solid"
                                            name="tanggal_lahir" id="tanggal_lahir" value="<?=$anggota->tanggal_lahir?>"/>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select class="form-control form-control-lg form-control-solid"
                                            ...
                                            <option value="<?=$anggota->kedudukan_fungsi?>"><?=$anggota->kedudukan_fungsi?></option>
                                ...
                                <div class="col-lg-5 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select class="form-control form-control-lg form-control-solid"
                                            ...
                                            <option value="<?=$anggota->pendidikan?>"><?=$anggota->pendidikan?></option>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <select class="form-control form-control-lg form-control-solid" name="pekerjaan"
                                            ...
                                            <option value="<?=$anggota->pekerjaan?>"><?=$anggota->pekerjaan?></option>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea class="form-control form-control-lg form-control-solid" name="alamat"
                                            id="alamat"><?=$anggota->alamat?></textarea>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea class="form-control form-control-lg form-control-solid"
                                            name="keterangan" id="keterangan"><?=$anggota->keterangan?></textarea>
                                    </div>
                                    <!--end::Form Group-->
                                </div>
                            </div>
