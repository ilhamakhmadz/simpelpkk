<div class="card">
    <div class="card-body p-12">
        <div class="row mb-12">
            <table id="dataTable_kerjasama_desa" class="table table-striped table-row-bordered gy-5 gs-7">
                <thead>
                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    <tr>
                        ...
                        <td><?=$data->tmt_kerjasama?></td>
                        <td>
                        <a href="<?=base_url()?>desa/kerjasama/edit/<?=$data->id?>" class="btn btn-icon btn-light-facebook me-5 " >
