<div class="card">
    <div class="card-body p-12">
        <div class="row mb-12">
            <table id="dataTable_pelatihan" class="table table-striped table-row-bordered gy-5 gs-7">
                <thead>
                    ...
                    foreach ($pelatihan as $data) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                foreach ($a as $desa) {
                                    if (!empty($desa->namapeserta)) {
                                        echo $desa->namapeserta . "<br>";
                                    } else {
                                        echo "<br>";
                                    }
                                }
                            ...
                            <td>
                                <a href="<?= base_url() ?>pelatihan/pelatihan/edit/<?= $data->id . "/" . $data->id_pelatihan ?>" class="btn btn-icon btn-light-facebook me-5 ">
                                ...
                                <a href="#" onclick="deleteItem(<?= $data->id . ',' . $data->id_pelatihan ?>)" class="btn btn-icon btn-light-google me-5 ">
