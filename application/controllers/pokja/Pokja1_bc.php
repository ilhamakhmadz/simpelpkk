...
class Pokja1 extends Admin_Controller
{
    ...
    public function index()
    {
        $this->load->vars(array(
            'page_icon' => '<a class="btn btn-active-accent fw-bolder" href="' . base_url('pokja/pokja1/add/') . '"> <i class="fa fa-plus"></i> Tambah Data</a>',
    ...
    public function add()
    {
        $this->load->vars(array(
            ...
            'page_icon' => '<a class="btn btn-active-accent fw-bolder" href="' . base_url('pokja/pokja1/index/') . '"> <i class="fa fa-reply"></i> Back</a>',
            'url_home' => '<li class="breadcrumb-item"><a href="' . base_url('dashboard/home') . '" class="text-muted text-hover-primary">Home</a></li>',
            'url_children' => '<li class="breadcrumb-item"><a href="' . base_url('pokja/pokja1') . '" class="text-muted text-hover-primary">Kegiatan Pokja I</a></li>',
    ...
    public function edit($id)
    {
        ...
        $this->load->vars(array(
            ...
            'page_icon' => '<a class="btn btn-active-accent fw-bolder" href="' . base_url('pokja/pokja1/'). '"> <i class="fa fa-reply"></i> Back</a>',
            'url_home' => '<li class="breadcrumb-item"><a href="' . base_url('dashboard/home') . '" class="text-muted text-hover-primary">Home</a></li>',
            'url_children' => '<li class="breadcrumb-item"><a href="' . base_url('pokja/pokja1') . '" class="text-muted text-hover-primary">Kegiatan Pokja I</a></li>',
    ...
    public function detail($kec, $desa)
    {
        ...
        $this->load->vars(array(
            'page_icon' => '<a class="btn btn-active-accent fw-bolder" href="' . base_url('pokja/pokja1') . '"> <i class="fa fa-reply"></i> Back</a>
                            <a class="btn btn-active-accent fw-bolder" href="' . base_url('pokja/pokja1/add/') . $kec.'/'.$desa.'"> <i class="fa fa-plus"></i> Tambah Data</a>',
