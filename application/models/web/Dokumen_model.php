...
{
    protected $table = 'dinas_dokumen';
    protected $join = 'master_dokumen';
    private $ci;
    ...
    public function datatables()
    {
        ...
        $this->datatables->join($this->join, 'dinas_dokumen.id_dokumen = master_dokumen.id');
    ...
    public function get_by_id($id)
    {
        ...
        $this->db->join($this->join, 'dinas_dokumen.id_dokumen = master_dokumen.id');
    ...
    public function get_by_id_doc($id)
    {
        ...
        $this->db->from($this->table);
        $this->db->join($this->join, 'dinas_dokumen.id_dokumen = master_dokumen.id');
        $this->db->where($this->table . '.id_dokumen', $id);
        $this->db->where($this->table . '.visible', 1);
        return $this->db->get()->result();
    }
}
