...
class Kerjasama_model extends MY_Model
{
    protected $table = 'desa_kerjasama';
    ...
    private function _get_select()
    {
        ...
        $select .= $this->table . ".jenis_kerjasama, ";
        $select .= $this->table . ".bentuk_kerjasama, ";
        $select .= $this->table . ".nama_pihak, ";
        $select .= $this->table . ".tmt_kerjasama, ";
        $select .= $this->table . ".lembaga_kerjasama, ";
        $select .= $this->table . ".nomor_perdes, ";
        $select .= $this->table . ".lembaga_bumdes, ";
        $select .= $this->table . ".nama_bumdes, ";
    ...
    {
        $this->datatables->select($this->_get_select()."COUNT(".$this->table . ".kode_desa) AS jml_kerjasama,");
