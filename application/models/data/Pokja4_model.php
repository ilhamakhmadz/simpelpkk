...
class Pokja4_model extends MY_Model
{
    protected $table = 'tbl_keg_pokja_4';
    ...
    private function _get_select()
    {
        ...
        $select .= $this->table . ".kader_posyandu, ";
        $select .= $this->table . ".kader_gizi, ";
        $select .= $this->table . ".kader_kesling, ";
        $select .= $this->table . ".kader_penyuluhan_narkoba, ";
        $select .= $this->table . ".kader_phbs, ";
        $select .= $this->table . ".kader_kb, ";
        $select .= $this->table . ".kes_posyandu_jml, ";
        $select .= $this->table . ".kes_posyandu_terintegrasi, ";
        $select .= $this->table . ".kes_posyandu_klp, ";
        $select .= $this->table . ".kes_posyandu_lansia_anggota, ";
        $select .= $this->table . ".kes_posyandu_lansia_kartu_gratis, ";
        $select .= $this->table . ".rumah_jamban, ";
        $select .= $this->table . ".rumah_spai, ";
        $select .= $this->table . ".rumah_pembuangan_sampah, ";
        $select .= $this->table . ".jml_mck, ";
        $select .= $this->table . ".krt_pdam, ";
        $select .= $this->table . ".krt_sumur, ";
        $select .= $this->table . ".krt_lainnya, ";
        $select .= $this->table . ".jum_pus, ";
        $select .= $this->table . ".jum_wus, ";
        $select .= $this->table . ".akseptor_kb_l, ";
        $select .= $this->table . ".akseptor_kb_p, ";
        $select .= $this->table . ".pnya_tab_keluarga, ";
    ...
    {
        $this->db->select('SUM(kader_posyandu) as jml_kader_posyandu,
        SUM(kader_gizi) as jml_kader_gizi,
        SUM(kader_kesling) as jml_kader_kesling,
        SUM(kader_penyuluhan_narkoba) as jml_kader_penyuluhan_narkoba,
        SUM(kader_phbs) as jml_kader_phbs,
        SUM(kader_kb) as jml_kader_kb,
        SUM(kes_posyandu_jml) as jml_kes_posyandu_jml,
        SUM(kes_posyandu_terintegrasi) as jml_kes_posyandu_terintegrasi,
        SUM(kes_posyandu_klp) as jml_kes_posyandu_klp,
        SUM(kes_posyandu_lansia_anggota) as jml_kes_posyandu_lansia_anggota,
        SUM(kes_posyandu_lansia_kartu_gratis) as jml_kes_posyandu_lansia_kartu_gratis,
        SUM(rumah_jamban) as jml_rumah_jamban,
        SUM(rumah_spai) as jml_rumah_spai,
        SUM(rumah_pembuangan_sampah) as jml_rumah_pembuangan_sampah,
        SUM(jml_mck) as jml_jml_mck,
        SUM(krt_pdam) as jml_krt_pdam,
        SUM(krt_sumur) as jml_krt_sumur,
        SUM(krt_lainnya) as jml_krt_lainnya,
        SUM(jum_pus) as jml_jum_pus,
        SUM(jum_wus) as jml_jum_wus,
        SUM(akseptor_kb_l) as jml_akseptor_kb_l,
        SUM(akseptor_kb_p) as jml_akseptor_kb_p,
        SUM(pnya_tab_keluarga) as jml_pnya_tab_keluarga');
        $this->db->where($this->table . '.kode_kecamatan', $kec);
        $this->db->where($this->table . '.date_year', $year);
        $this->db->where($this->table . '.visible', 1);
