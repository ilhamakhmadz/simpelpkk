...
class MY_Model extends CI_Model
{
     ...
     * @return array
     */
    public function get_list($base_url = '', $offset = 0, $limit = 0)
    {
     ...
     */
    public function add_filter_field($filter)
    {
        if (!is_array($filter)) {
            return false;
        }
     ...
     */
    public function remove_fitler_field($field_name)
    {
     ...
     */
    public function is_filter_prep()
    {
     ...
     */
    public function get_row_count($filters = array(), $table_name = null)
    {
     ...
     */
    public function prep_sorters($sort_string = '')
    {
     ...
     */
    public function is_sorter_prep()
    {
     ...
     * @return array
     */
    public function generate_options($tree, $sep = '')
    {
        $result = array();
    ...
    public function get_dropdown_array($display_field, $id_field = '')
    {
        if (empty($id_field)) {
