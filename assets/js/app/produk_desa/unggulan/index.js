...
$(document).ready(function ()
{
    the_table = $("#dataTable_kerjasama_desa").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/produk_desa/Api_unggulan',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "jml_produk" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href = "' + site_url + 'produk_desa/unggulan/view/' + row.kode_desa + '" class="btn btn-icon btn-light-twitter me-5 " >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/produk_desa/Api_unggulan/delete/" + $id;
}