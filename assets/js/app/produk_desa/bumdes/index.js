...
{
    the_table = $("#dataTable_bumdes_desa").DataTable({
        responsive: true,
        searching: true,
        processing: true,
        serverSide: true,
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/produk_desa/Api_bumdes',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "jenis_usaha" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                // return '<a href="' + site_url + 'produk_desa/bumdes/view/' + row.id + '" class="btn btn-icon btn-light-twitter me-5 ">\n\
                ...
                //         </svg ></span > </a >\n\
                return '<a href="' + site_url + 'produk_desa/bumdes/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/produk_desa/Api_bumdes/delete/" + $id;
}