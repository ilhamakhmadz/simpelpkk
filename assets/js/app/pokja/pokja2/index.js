...
$(document).ready(function() {
    the_table = $("#dataTable_kecamatan").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/pokja/Api_pokja2/kecamatan',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
            ...
            { "data": "jmltamanbacaan" },
            {
                ...
                "orderable": false,
                "render": function(data, type, row, meta) {
                    return '<a href = "' + site_url + 'pokja/pokja2/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
    ...
    the_table1 = $("#dataTable_desa").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/pokja/Api_pokja2/desa',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
    ...
    the_table2 = $("#dataTable_dusun").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/pokja/Api_pokja2/dusun',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
    ...
    the_table3 = $("#dataTable_rw").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/pokja/Api_pokja2/rw',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
    ...
    the_table4 = $("#dataTable_rt").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/pokja/Api_pokja2/rt',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
...
function deleteYes($id) {
    ...
    window.location = site_url + "api/pokja/Api_pokja2/delete/" + $id;
}