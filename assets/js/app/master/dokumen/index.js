function deleteItem($id)
{
    ...
    //             window.location = site_url + "api/master/Api_dokumen/delete/" + $id;
    //         } else {
...
$(document).ready(function ()
{
    the_table = $("#dataTable_dokumen").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/master/Api_dokumen',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href="' + site_url + 'master/dokumen/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 ">\n\
