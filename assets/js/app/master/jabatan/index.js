function deleteItem($id)
{
    ...
    //             window.location = site_url + "api/master/Api_jabatan/delete/" + $id;
    //         } else {
...
{
    the_table = $("#dataTable_jabatan").DataTable({
        responsive: true,
        searching: true,
        processing: true,
        serverSide: true,
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/master/Api_jabatan',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href="' + site_url + 'master/jabatan/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 ">\n\
