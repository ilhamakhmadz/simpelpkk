...
$(document).ready(function() {
    the_table = $("#dataTable_kecamatan").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/master/Api_kecamatan',
            "type": "POST"
        },
        "columns": [{
                "data": "Kd_Kec",
            ...
            },
            {
                ...
                "orderable": false,
                "render": function(data, type, row, meta) {
                    if (row.username != null & row.level_id == 3) {
                        return '<a href="' + site_url + 'master/kecamatan/detail/' + row.Kd_Kec + '" class="btn btn-icon btn-light-facebook me-5 ">\n\
                                ...
                                <a href="' + site_url + 'master/kecamatan/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 ">\n\
                        ...
                        <a href="' + site_url + 'master/kecamatan/generate_user_kecamatan/' + row.id + '" class="btn btn-icon btn-light-instagram me-5 ">\n\
    ...
    the_table1 = $("#non_dataTable_kecamatan").DataTable({
        responsive: true,
        searching: true,
        processing: true,
        serverSide: true,
