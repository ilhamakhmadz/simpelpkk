function deleteItem($id)
{
    ...
    //             window.location = site_url + "api/master/Api_pelatihan/delete/" + $id;
    //         } else {
...
$(document).ready(function ()
{
    the_table = $("#dataTable_pelatihan").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/master/Api_pelatihan',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href="' + site_url + 'master/pelatihan/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 ">\n\
