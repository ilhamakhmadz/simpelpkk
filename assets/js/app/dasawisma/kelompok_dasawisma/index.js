...
$(document).ready(function() {
    the_table = $("#dataTable_kecamatan").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_kelompok_dasawisma/kecamatan',
            "type": "POST"
        },
        "columns": [{
            ...
            { "data": "jumlah_kk" },
            { "data": "rumah_sehat_layak_huni" },
            {
                "data": "id_data_kelompok_dasawisma",
                "orderable": false,
                "render": function(data, type, row, meta) {
                    return '<a href="' + site_url + 'dasawisma/kelompok_dasawisma/view/' + row.id_data_kelompok_dasawisma + '" class="btn btn-icon btn-light-twitter me-5 ">\n\
                            ...
                            <a href = "' + site_url + 'dasawisma/kelompok_dasawisma/edit/' + row.id_data_kelompok_dasawisma + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
                            ...
                            <a href="#" onclick="deleteItem(' + row.id_data_kelompok_dasawisma + ')" class="btn btn-icon btn-light-google me-5 ">\n\
    ...
    the_table1 = $("#dataTable_desa").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_kelompok_dasawisma/desa',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_keluarga",
    ...
    the_table2 = $("#dataTable_dusun").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_kelompok_dasawisma/dusun',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_keluarga",
    ...
    the_table3 = $("#dataTable_rw").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_kelompok_dasawisma/rw',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_keluarga",
    ...
    the_table4 = $("#dataTable_rt").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_kelompok_dasawisma/rt',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_keluarga",
...
function deleteYes($id) {
    ...
    window.location = site_url + "api/dasawisma/Api_kelompok_dasawisma/delete/" + $id;
}