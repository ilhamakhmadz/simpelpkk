...
$(document).ready(function() {
    the_table = $("#dataTable_kecamatan").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_rekapitulasi_data',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_rekapitulasi",
                "searchable": false,
            ...
            { "data": "nama_suami" },
            {
                ...
                "orderable": false,
                "render": function(data, type, row, meta) {
                    return '<a href="' + site_url + 'dasawisma/rekapitulasi_data/view/' + row.id_data_rekapitulasi + '" class="btn btn-icon btn-light-twitter me-5 ">\n\
                            ...
                            <a href = "' + site_url + 'dasawisma/rekapitulasi_data/edit/' + row.id_data_rekapitulasi + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
                            ...
                            <a href="#" onclick="deleteItem(' + row.id_data_rekapitulasi + ')" class="btn btn-icon btn-light-google me-5 ">\n\
    ...
    the_table1 = $("#dataTable_desa").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_rekapitulasi_data/desa',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_rekapitulasi",
    ...
    the_table2 = $("#dataTable_dusun").DataTable({
        ...
        "ajax": {
            "url": site_url + 'api/dasawisma/Api_rekapitulasi_data/dusun',
            "type": "POST"
        },
        "columns": [{
                "data": "id_data_rekapitulasi",
...
function deleteYes($id) {
    ...
    window.location = site_url + "api/dasawisma/Api_rekapitulasi_data/delete/" + $id;
}