...
$("#form_edit").submit(function() {
    ...
    $.ajax({
        url: site_url + "api/dasawisma/Api_rekapitulasi_data/edit/" + $('#id_data_rekapitulasi').val(),
        method: 'post',
        dataType: 'json',
        data: formInput,
        contentType: false,
        ...
        success: function() {
            ...
            window.location.href = site_url + "dasawisma/rekapitulasi_data/edit/" + $('#id_data_rekapitulasi').val();
...
function addAnggota() {
    ...
    $.ajax({
        url: site_url + "api/dasawisma/Api_rekapitulasi_data/add_anggota/",
        method: 'post',
        dataType: 'json',
        data: formInput,
        contentType: false,
...
function editAnggota($id) {
    ...
    $.ajax({
        url: site_url + "api/dasawisma/Api_rekapitulasi_data/edit_anggota/" + $('#id_data_keluarga_anggota' + $id).val(),
        method: 'post',
        dataType: 'json',
        data: formInput,
        contentType: false,
...
function deleteAnggotaYes($id) {
    ...
    window.location = site_url + "api/dasawisma/Api_rekapitulasi_data/deleteAnggota/" + $id;
}