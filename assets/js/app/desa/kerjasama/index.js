...
$(document).ready(function ()
{
    the_table = $("#dataTable_kerjasama_desa").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/desa/Api_kerjasama',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "jml_kerjasama" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href = "' + site_url + 'desa/kerjasama/view/' + row.kode_desa + '" class="btn btn-icon btn-light-twitter me-5 " >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/desa/Api_kerjasama/delete/" + $id;
}