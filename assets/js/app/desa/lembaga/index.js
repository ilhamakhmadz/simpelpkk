...
{
    the_table = $("#dataTable_lembaga_desa").DataTable({
        responsive: true,
        searching: true,
        processing: true,
        serverSide: true,
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/desa/Api_lembaga',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "posyandu" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                // return '<a href="' + site_url + 'desa/lembaga/view/' + row.id + '" class="btn btn-icon btn-light-twitter me-5 ">\n\
                ...
                //         </svg ></span > </a >\n\
                return '<a href="' + site_url + 'desa/lembaga/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/desa/Api_lembaga/delete/" + $id;
}