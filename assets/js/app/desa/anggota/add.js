$(document).ready(function() {
    ...
    $("#form_add").validate({
        submitHandler: function(form) {
            ...
            formInput.append('kode_kecamatan', $('#kode_kecamatan').val());
            formInput.append('kode_desa', $('#kode_desa').val());
            ...
            formInput.append('date_year', $('#date_year').val());
            ...
            $.ajax({
                url: site_url + "api/desa/Api_anggota/add",
                method: 'post',
                dataType: 'json',
                data: formInput,
                contentType: false,
                ...
                success: function() {
                    ...
                    setTimeout(function() {
                            window.location.href = site_url + "desa/anggota/detail/" + $('#id_data').val();
                        },
                        2000)
                },
                error: function(err) {
