...
{
    the_table = $("#dataTable_keuangan_desa").DataTable({
        responsive: true,
        searching: true,
        processing: true,
        serverSide: true,
        ...
        "footerCallback": function (row, data, start, end, display)
        {
            ...
            $(api.column(4).footer()).html(
                "Rp. " + numeral(pageTotal4).format('0,00,0') + " <br>(Total : Rp." + numeral(total4).format('0,00,0') + ")"
            );
            $(api.column(5).footer()).html(
                "Rp. " + numeral(pageTotal5).format('0,00,0') + " <br>(Total : Rp." + numeral(total5).format('0,00,0') + ")"
            );
            $(api.column(6).footer()).html(
                "Rp. " + numeral(pageTotal6).format('0,00,0') + " <br>(Total : Rp." + numeral(total6).format('0,00,0') + ")"
            );
        },


        "ajax": {
            "url": site_url + 'api/desa/Api_keuangan',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "Nama_Desa" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return numeral(data).format('0,00,0');
            }
        },
        {
            "data": "adpd",
        ...
        },
        {
            ...
            "render": function (data, type, row, meta)
            {
                // '<a href="' + site_url + 'desa/keuangan/view/' + row.id + '" class="btn btn-icon btn-light-twitter me-5 ">\n\
                ...
                //         </svg ></span > </a >\n\
                return '<a href="' + site_url + 'desa/keuangan/edit/' + row.id + '" class="btn btn-icon btn-light-facebook me-5 " >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/desa/Api_keuangan/delete/" + $id;
}