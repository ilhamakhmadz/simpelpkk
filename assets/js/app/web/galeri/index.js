...
$(document).ready(function() {
    the_table = $("#dataTable_galeri").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/web/Api_galeri',
            "type": "POST"
        },
        "columns": [{
                "data": "id",
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\n\
                        ...
                        <a href = "' + site_url + 'web/galeri/edit/' + row.id + '" class="btn btn-icon btn-light-twitter me-5 " title = "Edit Data" >\n\
...
function deleteYes($id) {
    ...
    window.location = site_url + "api/web/Api_galeri/delete/" + $id;
}