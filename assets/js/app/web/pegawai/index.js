...
$(document).ready(function ()
{
    the_table = $("#dataTable_pegawai").DataTable({
        ...
        stateSave: true,
        "ajax": {
            "url": site_url + 'api/web/Api_pegawai',
            "type": "POST"
        },
        "columns": [{
            "data": "id",
        ...
        { "data": "nama_jabatan" },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return row.nama + '<br><b><i>NIP : ' + row.nip + '</i></b>';
            }
        },
        {
            "data": "gambar",
            ...
            "render": function (data, type, row, meta)
            {
                if (row.gambar)
                {
                    img = site_url + atob(row.gambar);
                } else
                {
                    img = site_url + '/assets/admin_assets/assets/media/avatars/blank.png';

                }
                return '<div class="symbol symbol-60px symbol-2by3 me-4">\n\
                    <img src = "'+ img + '" alt = "" class="mw - 100" >\n\
                    </div >';
            }
        },
        {
            ...
            "render": function (data, type, row, meta)
            {
                return '<a href = "' + site_url + 'web/pegawai/edit/' + row.id + '" class="btn btn-icon btn-light-twitter me-5 " title = "Edit Data" >\n\
...
function deleteYes($id)
{
    ...
    window.location = site_url + "api/web/Api_pegawai/delete/" + $id;
}
