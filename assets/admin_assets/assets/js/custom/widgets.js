...
var KTWidgets = function() {
    var t = function(t, e, a, o, s) {
        ...
        if (i) {
            var l = { series: [{ name: "Net Profit", data: a }, { name: "Revenue", data: o }], chart: { fontFamily: "inherit", type: "bar", height: r, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["40%"], endingShape: "rounded" } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-700"), fontSize: "12px" } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-700"), fontSize: "12px" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(t) { return "$" + t + " thousands" } } }, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")], grid: { borderColor: KTUtil.getCssVariableValue("--bs-gray-200"), strokeDashArray: 4, yaxis: { lines: { show: !0 } } } },
                n = new ApexCharts(i, l),
                d = !1,
                c = document.querySelector(t);
            !0 === s && (n.render(), d = !0), c.addEventListener("shown.bs.tab", (function(t) { 0 == d && (n.render(), d = !0) }))
        }
    };
    return {
        init: function() {
            ...
            ! function() {
                ...
                }(), (e = document.querySelector("#kt_forms_widget_1_form")) && e && new Quill("#kt_forms_widget_1_editor", { modules: { toolbar: { container: "#kt_forms_widget_1_editor_toolbar" } }, placeholder: "What is on your mind ?", theme: "snow" })
        }
    }
}();
KTUtil.onDOMContentLoaded((function() { KTWidgets.init() }));